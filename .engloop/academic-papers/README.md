...
- Distinguish implementation facts, measured results, calculations, hypotheses, proposals, and future work.
- Never invent novelty, citations, measurements, baselines, deployments, or peer-review acceptance.
- Inspect every rendered PDF page and maintain claim-evidence/citation validation.
