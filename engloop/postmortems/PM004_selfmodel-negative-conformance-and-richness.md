...
PM002/PM003 made the vertical bar concrete: a self-model (`MDL` + `CRD`) that **generates
...
- **LRN001** — A self-model criterion must grade the model's **behavioral adequacy** (does it branch;
...
- **LRN002** — **Model-derived** is the load-bearing word: if a human hand-codes the error assertion,
...
- **LRN003** — Positive conformance and negative conformance are **different guarantees**. "Every
