...
- **Affected:** the Readiness Gate's **vertical self-model** criterion (`MDL` + `CRD` that
...
So a consuming project can satisfy the gate — "vertical is self-modelled, MDL+CRD present,
