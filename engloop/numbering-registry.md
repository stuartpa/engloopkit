...
| `IN` | Incidents | `IN001` | IN001 = a consumer (SEK) was declared "ready for incidents" with no readiness bar met |
| `PM` | Post-mortems | `PM001` | PM001 = no enforced readiness gate (narrated readiness); RPI001-003 |
