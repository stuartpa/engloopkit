...
agents: []
hooks: { SessionStart: [{ type: "command", command: "dotnet tool run engloopkit validate agent-entry --stage speckit.engloop.62-academic-paper-create --root .", timeout: 30 }] }
---
