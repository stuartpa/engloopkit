---
name: speckit.engloop.71-powerpnt-create
description: Create a Markdown-first PowerPoint deck explaining the North Star, layered architecture, Spec Explorer behavior models, and generated test paths.
...
agents: []
hooks: { SessionStart: [{ type: "command", command: "dotnet tool run engloopkit validate agent-entry --stage speckit.engloop.71-powerpnt-create --root .", timeout: 30 }] }
---
...
`dotnet tool run engloopkit validate agent-entry --stage speckit.engloop.71-powerpnt-create --root .`
