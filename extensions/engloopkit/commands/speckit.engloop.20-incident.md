...
argument-hint: "--incident <.engloop/incidents/INxxx_title.md> [incident demand and mitigation scope]"
target: vscode
user-invocable: true
...
handoffs:
  - label: Analyze stabilized incidents
    ...
    prompt: Analyze the selected stabilized incident set above with --postmortem <.engloop/postmortems/PMxxx_title.md>; consult current NORTHSTAR.md and the relevant LEARNINGS.md card/source path, classify rule effects, and produce validated learning-bound repair items.
    send: false
---
