---
name: speckit.engloop.50-pomodoro-create
description: Capture concise evidence-backed notes about the work completed in the
...
hooks:
  SessionStart:
  - type: command
    command: dotnet tool run engloopkit validate agent-entry --stage speckit.engloop.50-pomodoro-create
      --root .
    timeout: 30
---
...
`dotnet tool run engloopkit validate agent-entry --stage speckit.engloop.50-pomodoro-create --root .`
